...
: tim4isr
	Tim3ArrVal @ TIM3_ARR_R h!
	1 TIM4_BASE 2dup 
	TIM_DIER + hbic!
	TIM_SR + hbic!
	1 TIM3_BASE TIM_DIER + hbis!
	1 GPIOA_BASE GPIO_ODR + hbis!
;
...
: init-count
	...
	GetTIM2-4Clk $10000 /mod 
	1- Tim4ArrVal ! 1- Tim3ArrVal !
	
	$0084 TIM3_BASE TIM_CR1 + h!
	...
	\ init PA0 for output PP to debug events
	GPIOA_BASE GPIO_CRL + dup
	@ $0000000F bic $2 or swap !
;
...
: fcounter1 
	...
	begin 
		FreqRdy @ if 
			...
			1+ dup 10 mod 0= if 
				drop 0 
				Tim3ArrVal @ 400 - dup Tim3ArrVal ! 0 < if 
					-1 Tim4ArrVal +! 
					$FFFF Tim3ArrVal +! 
				then 
				Tim4ArrVal @ . 
