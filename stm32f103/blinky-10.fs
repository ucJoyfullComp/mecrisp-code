...
include blinky-10-register-memory-map.fs
include multitask.fs

%1111  13 8 - 4 * lshift GPIOB_CRHR bic!
%0001  13 8 - 4 * lshift GPIOB_CRHR bis!
%1111  12 8 - 4 * lshift GPIOB_CRHR bic!
%0001  12 8 - 4 * lshift GPIOB_CRHR bis!
