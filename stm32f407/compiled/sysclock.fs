...
: ReleaseMCO1 ( -- )
    ...
    gpioa_base gpio_otyper + dup @ $0100 bic swap ! 
    gpioa_base gpio_pupdr + dup @ $00030000 bic swap ! 
    gpioa_base gpio_ospeeder + dup @ $00030000 bic swap ! 
    gpioa_base gpio_afrh + dup @ $0000000F bic swap ! 
;    
...
: TurnOnMCO2
    ...
    gpioc_base gpio_ospeeder + dup @ $000C0000 bic $000C0000 or swap ! 
...
: ReleaseMCO2 ( -- )
    ...
    gpioc_base gpio_otyper + dup @ $0200 bic swap ! 
    gpioc_base gpio_pupdr + dup @ $000C0000 bic swap ! 
    gpioc_base gpio_ospeeder + dup @ $000C0000 bic swap ! 
    gpioc_base gpio_afrh + dup @ $000000F0 bic swap ! 
;    
...
\ use port E11 to toggle as fast as possible to check cpu freq 
    ...
    %11 11 2* lshift $00C00000 gpioe_base gpio_ospeeder + @|+!
